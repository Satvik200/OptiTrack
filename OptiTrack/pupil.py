...
class Pupil(object):
    def __init__(self, eye_frame, threshold):
        ...
        self.x = None
        self.y = None
        self.detectIris(eye_frame)

    # Performs operations on the eye frame to isolate the iris
    @staticmethod
    def imageProcessing(eye_frame, threshold):
    ...
    def detectIris(self, eye_frame):
        self.iris_frame = self.imageProcessing(eye_frame, self.threshold)
