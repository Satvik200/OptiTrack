...
class Eye(object):
    ...
    def __init__(self, original_frame, landmarks, side, calibration):
        ...
        self.analyzer(original_frame, landmarks, side, calibration)
    ...
    # Calculate ratio that can indicate whether an eye is closed or not
    # Divide width of the eye by its height
    ...
    # Detect and isolate the eye in a new frame -> send data to the calibration and initialize Pupil object
    def analyzer(self, original_frame, landmarks, side, calibration):
        if side == 0:
